...
* Bug fixed related to on click popups that are set to appear on dropdownâ€™s menu items.
...
= Version 3.69.2 =
* Code improvement.
* Debug mode added: Now itâ€™s easier to find the issues that our users face.
...
* Improvement of subscribersâ€™ import functionality, all CSV file formats are supported (CSV UTF-8, Comma delimited, Macintosh, MS-DOS)
...
= Version 3.67 =
* The Popup Builder posts were removed from sitemaps which is being generated by WordPress SEO Plugin Ã¢â‚¬â€œ Rank Math.
